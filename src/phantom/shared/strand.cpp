...
void construct_strand(Strand *strand, int strand_i, int bundle_i, double *control_points,
    ...
    init_strand(strand, strand_i, bundle_i, num_strand_control_points, strand_r, start_point,
            end_point);
