...
namespace FTS {
    ...
    namespace Diffusion {
        ...
        class Encoding {
            ...
            public:
                ...
                Encoding(const Triple<double>& orientation, double b_value)
                        : b(b_value), orient(orientation) {
                    normalise_orient();
                }
                
                Encoding(const Triple<double>& direction)
                        : b(direction.norm()), orient(direction) {
                    normalise_orient();
                }
                ...
                static std::vector<Encoding> parse_encodings(
                        const MR::Math::Matrix<double>::View& encodings_matrix);

                static MR::Math::Matrix<double> encodings_matrix(
        ...
        inline std::vector<Encoding> parse_encodings(
                const MR::Math::Matrix<double>::View& encodings_matrix) {
