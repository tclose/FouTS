...
namespace BTS {
  ...
  namespace File {
    ...
    inline bool                                  exists(const std::string& path) { return MR::Path::exists(path); }
    ...
    inline bool                                  is_dir(const std::string path) { return MR::Path::is_dir(path); }


    inline bool                                  is_file (const std::string path) { return MR::Path::is_file(path); }


    inline std::string                           join (const std::string& first, const std::string& second) { return MR::Path::join(first,second); }
    ...
    inline std::string                           basename(std::string location) { return MR::Path::basename(location); }


    inline std::string                           dirname(std::string location)  { return MR::Path::dirname(location); }
    ...
    inline bool                                  has_txt_extension (const std::string& name, const std::string& suffix)
      { return has_extension(name, TXT_FILE_EXTENSTION) && has_extension(strip_extension(name), suffix); }
    ...
    template <typename T> bool                   has_txt_or_set_extension(const std::string& location)
      { return has_or_set_extension<T>(location) || has_or_txt_extension<typename T::Set>(location); }


    std::vector<std::string>                     list_filenames(std::string dir_location, std::string prefix = std::string(""), std::string suffix = std::string(""));
    
    
    template <typename T> std::vector<T>&        load_vector(std::string location, std::vector<T>& vector) {
