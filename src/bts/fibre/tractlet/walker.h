...
#ifndef __bts_fibre_tractlet_walker_h__
#define __bts_fibre_tractlet_walker_h__
...
namespace BTS {
    ...
    namespace Fibre {
        ...
        class Tractlet::Walker: public MCMC::Proposal::Walker {
            ...
            public:
                ...
                Walker(MCMC::Proposal::Distribution* const proposal_distribution,
                       const Tractlet& relative_step_sizes)
...
#endif /* __bts_fibre_tractlet_walker_h__ */
