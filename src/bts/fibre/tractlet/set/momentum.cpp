...
namespace BTS {
    ...
    namespace Fibre {
        ...
        const char* Tractlet::Set::Momentum::STEP_LOCATION_DEFAULT =
                "/home/tclose/data/mcmc/hamiltonian/params/stepsizes/default.tct";
        
        Tractlet::Set::Momentum Tractlet::Set::Momentum::factory(
