...
//        class Tensor;
      ...
      public:
                ...
                double length_epsilon)
        {
          ...
          position() = tractlet[0].left_product(position_coeffs) + ax1_fraction * width1() + ax2_fraction * width2();
          ...
          tangent()  = (tractlet[0].left_product(tangent_coeffs)
                        ...
                        + ax2_fraction * tractlet[2].left_product(tangent_coeffs)) * length_fraction;
