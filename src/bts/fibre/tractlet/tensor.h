...
//        typedef Base::TensorWriter<Tractlet::Tensor> Writer;
      ...
      public:
        ...
        Tensor (const Tractlet& tractlet_template, const MR::Math::Matrix<double>::View& view)
        ...
        Tensor& operator=(const Tensor& t)
          { Base::Tensor<Tractlet>::operator=(t); return *this; }

        Tensor& operator=(const MR::Math::Matrix<double>& m)
          { Base::Tensor<Tractlet>::operator=(m); return *this; }

        Tensor& operator=(double c)
          { Base::Tensor<Tractlet>::operator=(c); return *this; }
