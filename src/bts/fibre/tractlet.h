  ...
  namespace Fibre {
    ...
    class Tractlet : public Base::Object {
      ...
      public:
        ...
        static size_t total_num_sections(size_t num_length_sections, size_t num_width_sections)
      ...
      public:
        ...
        Coord                         operator()(size_t axis_i, size_t degree_i) {
          ...
          return Coord(sub((axis_i * degree() + degree_i) * 3, (axis_i * degree() + degree_i) * 3 + 3));
        }
        ...
        void                          add_section_gradient(const Tractlet& tractlet, const Section& section, const Strand::BasicSection& gradient);
        ...
        double                        distance(const Tractlet& reference, bool& flipped, bool& switched, bool& invert1, bool& invert2) const;
      ...
      protected:
        ...
        void                          clear(const std::vector<const char*>& properties)
          { Object::clear(properties); dgree = 0; }
