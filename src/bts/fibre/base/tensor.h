            ...
            template<typename T> class Tensor: public MR::Math::Matrix<double> {
                ...
                public:
                    ...
                    Tensor(const T& fibre_template)
                            : MR::Math::Matrix<double>(fibre_template.vsize(),
                                      fibre_template.vsize()), tmpl(fibre_template) {
                        tmpl.zero();
                    }
                    
                    Tensor(const T& fibre_template, const MR::Math::Matrix<double>::View& view)
                            : MR::Math::Matrix<double>(view), tmpl(fibre_template) {
                        tmpl.zero();
                    }
                    ...
                    Tensor& operator=(const MR::Math::Matrix<double>& m) {
                        assert(m.rows() == vsize());
                        assert(m.columns() == vsize());
                        MR::Math::Matrix<double>::operator=(m);
                        return *this;
                    }
