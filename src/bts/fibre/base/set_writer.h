        ...
        namespace Base {
            ...
            template<typename T> class SetWriter: public Fibre::Base::Writer<T> {
                ...
                public:
                    ...
                    template<typename U> SetWriter(
                            const std::string& location, const U& set_or_reader,
                    ...
                    template<typename U> SetWriter(
                            ...
                            const std::map<std::string, std::string>& file_props = Properties()) {
                        create(location, set_or_reader, extend_prop_keys, extend_elem_prop_keys,
                                file_props);
                    }
                    ...
                    template<typename U> void create(
                            const std::string& location, const U& set_or_reader,
                            const std::map<std::string, std::string>& file_props = Properties()) {
                        create(location, Object::select_props<T>(set_or_reader.prop_keys()),
                                Object::select_props<typename T::Element>(
                                        set_or_reader.elem_prop_keys()),
                                set_or_reader.extend_prop_keys(),
                                set_or_reader.extend_elem_prop_keys(), file_props);
                    }
                    ...
                    template<typename U> void create(
                        ...
                        create(location, Object::select_props<T>(set_or_reader.prop_keys()),
                                Object::select_props<typename T::Element>(
                                        set_or_reader.elem_prop_keys()), extend_prop_keys,
                                set_or_reader.extend_elem_prop_keys(), file_props);
                    }
                    ...
                    template<typename U> void create(
                        ...
                        create(location, Object::select_props<T>(set_or_reader.prop_keys()),
                                Object::select_props<typename T::Element>(
                                        set_or_reader.elem_prop_keys()), extend_prop_keys,
                                extend_elem_prop_keys, file_props);
                    }
                ...
                protected:
                    ...
                    void create(
                            ...
                            const std::vector<std::string> extend_prop_keys = std::vector<
                                    std::string>(),
                            const std::vector<std::string> extend_elem_prop_keys = std::vector<
                                    std::string>(),
                            const std::map<std::string, std::string>& file_props = Properties());
            ...
            template<typename T> class SetTextWriter: public SetWriter<T> {
                ...
                public:
                    ...
                    template<typename U> SetTextWriter(
                            const std::string& location, const U& set_or_reader,
                            const std::map<std::string, std::string>& file_props = Properties())
                    ...
                    template<typename U> SetTextWriter(
                            ...
                            const std::vector<std::string>& extend_elem_prop_keys,
                            const std::map<std::string, std::string>& file_props = Properties())
                            : SetWriter<T>(location, set_or_reader, extend_prop_keys,
                                    extend_elem_prop_keys, file_props) {
                    }
