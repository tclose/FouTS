...
#ifndef __bts_fibre_strand_set_momentum_h__
#define __bts_fibre_strand_set_momentum_h__
    ...
    namespace Fibre {
        ...
        class Strand::Set::Momentum {
            ...
            public:
                ...
                static Momentum factory(const Set& state, double step_scale,
            ...
            public:
                ...
                Momentum(MCMC::Proposal::Distribution* const proposal_distribution,
                         const Set& step_sizes)
                        
                        : mcmc_momentum(proposal_distribution, step_sizes) {
                }
                ...
                void update_state(Set& state) const {
                    ...
                    mcmc_momentum.update_state(state_vector);
                }
...
#endif /* __bts_fibre_strand_set_momentum_h__ */
