...
namespace BTS {
    ...
    const char*                 Strand::Set::Momentum::STEP_LOCATION_DEFAULT = "/home/tclose/data/mcmc/hamiltonian/params/stepsizes/default.str";


    Strand::Set::Momentum       Strand::Set::Momentum::factory( const Set& state,
                                                                double step_scale,
