...
namespace FTS {
    ...
    namespace Fibre {
        ...
        const double Strand::Set::Momentum::STEP_SCALE_DEFAULT = 1.0;
        const char* Strand::Set::Momentum::STEP_LOCATION_DEFAULT =
                "/home/tclose/data/mcmc/hamiltonian/params/stepsizes/default.str";
        
        Strand::Set::Momentum Strand::Set::Momentum::factory(
                const Set& state, double step_scale, const std::string& step_location,
            ...
            if (step_location.size()) {
                ...
                if (step.size() == 1) {
                    Fibre::Strand::Set full_step(state.size(), state.degree());
            ...
            return Fibre::Strand::Set::Momentum(proposal_distribution, step);
