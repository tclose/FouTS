  ...
  namespace Fibre {
    ...
    class Strand::BasicSection : public Base::Object {
      ...
      public:      
        ...
        BasicSection(const MR::Math::Vector<double>::View& view, std::vector<const char*>* props)
        ...
        { Base::Object::set(NAN); set(strand,position_coeffs,tangent_coeffs,length_fraction); }
      ...
      protected:
        ...
        BasicSection(size_t size, const MR::Math::Vector<double>::View& view, std::vector<const char*>* props)
      ...
      friend std::ostream& operator<< (std::ostream& stream , const Strand::BasicSection& seg);
    ...
    inline void                     Strand::BasicSection::normalize(const Triple<double>& vox_lengths, const Triple<double>& offsets) {
