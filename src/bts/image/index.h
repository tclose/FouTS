...
namespace FTS {
    ...
    namespace Image {
        ...
        class Index: public Triple<int> {
            ...
            public:
                ...
                inline bool bounded_by(const Triple<size_t>& A) const {
                    return (this->p[X] < (int) A[X]) && (this->p[Y] < (int) A[Y])
                           && (this->p[Z] < (int) A[Z]);
                }
                ...
                template<typename T> void bound(const Triple<T> &low_bound,
                                                const Triple<T> &up_bound);
                ...
                Triple<double> to_point() {
                    return Triple<double>((double) this->p[X], (double) this->p[Y],
                            (double) this->p[Z]);
                }
        ...
        template<typename T> void Index::bound(const Triple<T> &low_bound,
                                               const Triple<T> &up_bound) {
