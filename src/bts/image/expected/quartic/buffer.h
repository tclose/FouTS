...
#ifndef __bts_image_expected_quartic_buffer_h__
#define __bts_image_expected_quartic_buffer_h__
  ...
  namespace Image {
    ...
    namespace Expected {
      ...
      namespace Quartic {
        ...
        class Buffer : public Expected::Buffer, public Expected::Buffer_tpl<Quartic::Voxel> {
          ...
          public:
            ...
            Buffer() : Buffer_tpl<Quartic::Voxel>(this) {}
