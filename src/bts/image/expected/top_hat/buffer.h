...
#ifndef __bts_image_expected_tophat_buffer_h__
#define __bts_image_expected_tophat_buffer_h__
  ...
  namespace Image {
    ...
    namespace Expected {
      ...
      namespace TopHat {
        ...
        class Buffer  : public Expected::Buffer, public Expected::Buffer_tpl<TopHat::Voxel> {
          ...
          public:
            ...
            Buffer() : Buffer_tpl<TopHat::Voxel>(this) {}
