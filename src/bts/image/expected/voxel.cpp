...
namespace BTS {
  ...
  namespace Image {
    ...
    namespace Expected {
      ...
      Voxel::Voxel(Expected::Buffer& exp_image, const Index& coord, Diffusion::Model& diffusion_model)
          : Observed::Voxel(diffusion_model.num_encodings(), coord), precalc_interpolation(NAN) {
      ...
      Voxel::Voxel(const Voxel& v)
        :  Observed::Voxel(v), precalc_interpolation(v.precalc_interpolation), precalc_gradient(v.precalc_gradient) {
      ...
      double              Voxel::interpolate(const Fibre::Tractlet::Section& section, Fibre::Strand::BasicSection& gradient, Fibre::Tractlet::Section::Tensor& hessian) {
