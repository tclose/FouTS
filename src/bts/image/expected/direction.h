    ...
    namespace Expected {
      ...
      class Direction {
        ...
        public:
          ...
          double signal(const Fibre::Strand::Section& section, Fibre::Strand::BasicSection& gradient)
            { return signal_tpl(section,gradient); }

          double signal(const Fibre::Tractlet::Section& section, Fibre::Strand::BasicSection& gradient)
            { return signal_tpl(section,gradient); }
          
          double signal(const Fibre::Strand::Section& section, Fibre::Strand::BasicSection& gradient, Fibre::Strand::BasicSection::Tensor& hessian)
            { return signal_tpl(section,gradient,hessian); }

          double signal(const Fibre::Tractlet::Section& section, Fibre::Strand::BasicSection& gradient, Fibre::Strand::BasicSection::Tensor& hessian)
            { return signal_tpl(section,gradient,hessian); }
        ...
        protected:
          ...
          template <typename T> double    signal_tpl (const T& section, Fibre::Strand::BasicSection& gradient);

          template <typename T> double    signal_tpl (const T& section, Fibre::Strand::BasicSection& gradient, typename T::Tensor& hessian);

          static void                     signal_gradient(const Fibre::Strand::Section& section,
          ...
          static void                     signal_gradient(const Fibre::Tractlet::Section& section,
                                                          Fibre::Strand::BasicSection& gradient,
                                                          double diffusion_weighting,
                                                          double interpolation_weighting,
                                                          const Triple<double>& diffusion_gradient,
          ...
          static void                     signal_hessian(const Fibre::Strand::Section& section,
          ...
          static void                     signal_hessian(const Fibre::Tractlet::Section& section,
                                                          Fibre::Strand::BasicSection::Tensor& hessian,
                                                          double diffusion_weighting,
                                                          double interpolation_weighting,
                                                          const Triple<double>& diffusion_gradient,
