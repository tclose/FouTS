    ...
    namespace Observed {
      ...
      template <typename T> class Buffer_tpl : public Image::Buffer_tpl<T>  {
        ...
        public:
          ...
          static Triple<double>                 default_corner_offset(const Triple<size_t>& dimensions, const Triple<double>& voxel_lengths)
        ...
        public:
          ...
          void                        reset(const Triple<size_t>& dims,
        ...
        protected:
          ...
          Buffer_tpl(bool enforce_bounds) : Image::Buffer_tpl<T>(enforce_bounds){}

          Buffer_tpl( Triple<size_t> dimensions,
                          Triple<double> voxel_lengths,
          ...
          Buffer_tpl&                 operator= (const Buffer_tpl<T>& B)
            { this->Image::Buffer_tpl<T>::operator= (B); voxel_lengths = B.voxel_lengths; corner_offsets = B.corner_offsets; props = B.props; return *this; }
    ...
    namespace Observed {
      ...
      class Buffer : public Buffer_tpl<Voxel> {
        ...
        public:
          ...
          Buffer() : Buffer_tpl<Voxel>(true) {}

        //TODO: Make default constructor, and open functions.
          Buffer(const Triple<size_t>& dimensions, const Triple<double>& voxel_sizes, const Triple<double>& spatial_offset, const Diffusion::Encoding::Set& encodings)
            : Buffer_tpl<Voxel>(dimensions, voxel_sizes, spatial_offset, true),
              encodings(encodings)  { }


          Buffer(const std::string& image_location, const Diffusion::Encoding::Set& default_encodings = Diffusion::Encoding::Set())
          ...
          Buffer&                    operator=(const Buffer& B)
            { Buffer_tpl<Voxel>::operator=(B); encodings = B.encodings; return *this; }
          ...
          { Buffer_tpl<Voxel>::reset(dims, voxel_sizes, spatial_offset); this->encodings = encodings; }


          void                       load(const std::string& location, const Diffusion::Encoding::Set& default_encodings = Diffusion::Encoding::Set());
          ...
          Buffer&                     zero ()
            { this->Image::Buffer_tpl<Voxel>::zero(); return *this; }
          ...
          Buffer&                     operator+= (const Buffer& buff)
            { this->Image::Buffer_tpl<Voxel>::operator+= (buff); return *this; }
          ...
          Buffer&                     operator*= (double M)
            { this->Image::Buffer_tpl<Voxel>::operator*= (M); return *this; }
