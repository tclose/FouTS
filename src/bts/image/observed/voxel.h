...
namespace BTS {
    ...
    namespace Observed {
      ...
      class Voxel : public Image::Voxel<double> {
        ...
        public:
          ...
          Voxel(const Voxel& v)
            : Image::Voxel<double>(v), obs_image(v.obs_image), coordinate(v.coordinate), centre_point(v.centre_point) {}
          ...
          Voxel&                      copy_value (const Voxel& v)
            { Image::Voxel<double>::operator=(v); return *this; }
          ...
          double                       sum_strong_difference(const Voxel& expected_image, Voxel& expected_image_gradient, bool include_b0s) const;

          
          double                       sum_weak_difference(const Voxel& expected_image, Voxel& expected_image_gradient, bool include_b0s) const;
  ...
  //      friend class Observed::Buffer;
        ...
        friend std::ostream&          operator<< (std::ostream& stream, const Observed::Voxel& voxel);
