  ...
  namespace Image {
    ...
    namespace Observed {
      ...
      Voxel::Voxel(Observed::Buffer& obs_image, const Index& coord)
        : Image::Voxel<double>(obs_image.num_encodings()),
          obs_image(&obs_image),
          coordinate(coord),
          centre_point(Observed::Buffer::voxel_centre(coordinate)) {}


      Voxel::Voxel(size_t num_encodings, const Index& coord)
        : Image::Voxel<double>(num_encodings),
          obs_image(0),
          coordinate(coord),
          centre_point(Observed::Buffer::voxel_centre(coordinate)) {}
      ...
      double     Voxel::sum_weak_difference(const Voxel& expected_image, Voxel& expected_image_gradient, bool include_b0s)  const  {
      ...
      double     Voxel::sum_strong_difference(const Voxel& expected_image, Voxel& expected_image_gradient, bool include_b0s) const {
