...
#ifndef __bts_image_noise_gaussian_h__
#define __bts_image_noise_gaussian_h__
...
namespace BTS {
	...
	namespace Image {
		...
		class Noise::Gaussian : public Noise {
        ...
        Gaussian(gsl_rng* rand_gen, double snr, double ref_signal);


        Image::Observed::Buffer&     noisify(Image::Observed::Buffer& image)
          { noisify_tpl(image); return image; }
...
#endif /* __bts_image_noise_gaussian_h__ */
