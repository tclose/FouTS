...
namespace BTS {
    ...
    namespace MCMC {
        ...
        namespace Proposal {
            ...
            template<typename T> Momentum::Weighted::NonSeparable Momentum::Weighted::NonSeparable::factory(
...
//          step[i].acs = 0.0;
                ...
                return Momentum::Weighted::NonSeparable(proposal_distribution, step_vector,
                        num_newton_steps);
