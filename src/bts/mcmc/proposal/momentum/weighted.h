        ...
        namespace Proposal {
            ...
            class Momentum::Weighted: public Momentum {
                ...
                public:
                    ...
                    template<typename T> static Weighted factory(
                ...
                public:
                    ...
                    Weighted(Distribution* const prop_distr = 0)
                            : Momentum(prop_distr) {
                    }
                    
                    Weighted(Distribution* const proposal_distribution,
                    ...
                    template<typename T> void update_state(
                            T& state, const MR::Math::Matrix<double>& weights_chol,
                            double time_direction = 1.0) const {
                        MR::Math::Vector<double>& state_vector = state;
                        update_state(state_vector, weights_chol, time_direction);
                    }
                    ...
                    template<typename T> double predicted_change(
                            const T& gradient, const MR::Math::Matrix<double>& weights_chol,
                            double time_direction = 1.0) const {
