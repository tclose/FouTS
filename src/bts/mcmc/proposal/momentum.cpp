...
namespace BTS {
  ...
  namespace MCMC {
    ...
    namespace Proposal {
      ...
      const std::string  Momentum::STEP_LOCATION_DEFAULT  = "/home/tclose/data/mcmc/hamiltonian/params/momentum/scaling.sta";
      ...
      void               Momentum::half_update_momentum(const MR::Math::Vector<double>& gradient, double time_direction) {
      ...
      void               Momentum::update_state(MR::Math::Vector<double>& state, double time_direction) const {
      ...
      double             Momentum::predicted_change(const MR::Math::Vector<double>& gradient, double time_direction) const {
