  ...
  namespace Math {
    ...
    class USV {
      ...
      public:
        ...
        USV(size_t rows, size_t columns) : u(rows, columns), v(columns, columns), sigma(columns) {}
        ~USV() {}
    ...
    inline MR::Math::Vector<double>&          svd(MR::Math::Matrix<double>& matrix, MR::Math::Matrix<double>& v, MR::Math::Vector<double>& sigma) {
