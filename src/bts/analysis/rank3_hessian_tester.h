/*
 ...
 FouTS is objectibuted in the hope that it will be useful,
        ...
        template<typename Object, typename State> class Rank3HessianTester {
            ...
            public:
                ...
                void test(Function function, State& state, double step_size,
                          std::vector<typename State::Tensor>& analytic_rank3hessian,
                          std::vector<typename State::Tensor>& numeric_rank3hessian);
...
namespace FTS {
    ...
    namespace Analysis {
        ...
        template<typename Object, typename State> void Rank3HessianTester<Object, State>::test(
            ...
            MR::Math::Matrix<double> template_rank3hessian_matrix(state_vector.size(),
                    state_vector.size());
            template_rank3hessian_matrix = NAN;
            
            MR::ProgressBar progress_bar("Testing rank3hessian calculations...",
                    state_vector.size());
            ...
            for (size_t elem_i = 0; elem_i < state_vector.size(); ++elem_i) {
                ...
                (*object.*function)(perturbed_state, dummy_gradient, perturbed_hessian,
                        dummy_rank3hessian);
