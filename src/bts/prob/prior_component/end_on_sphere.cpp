...
namespace BTS {
  ...
  namespace Prob {
    ...
    namespace PriorComponent {
        ...
        double              EndOnSphere::radius_default(uint dim, double vox_length) {
...
//
//
//          for (uint degree_i1 = 0; degree_i1 < strand.degree(); degree_i1++) {
//            for (uint dim_i1 = 0; dim_i1 < 3; dim_i1++) {
//              for (uint degree_i2 = 0; degree_i2 < strand.degree(); degree_i2++) {
//                for (uint dim_i2 = 0; dim_i2 < 3; dim_i2++) {
//
...
//
//          uint vector_size = strand.vector_size();
//          uint has_density = strand.has_property("density");
//
//          double log_prob = 0.0;
//
//          gradient.zero();
...
//          for (uint elem_i = 0; elem_i < vector_size; ++elem_i) {
...
//                                  endpoints.second[dim_i1] * endpoints.second[dim_i2] / MR::Math::pow2(norm2);
//
//                  for (uint degree_i3 = 0; degree_i3 < strand.degree(); degree_i3++) {
//                    for (uint dim_i3 = 0; dim_i3 < 3; dim_i3++) {
