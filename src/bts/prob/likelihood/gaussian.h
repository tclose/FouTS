  ...
  namespace Prob {
    ...
    class Likelihood::Gaussian : public Likelihood {
      ...
      public:
        ...
        double                          log_prob_and_fisher( const Fibre::Tractlet::Set& tractlets,
          ...
          { return log_prob_and_fisher_tpl<Fibre::Tractlet>(tractlets, gradient, fisher_info, fisher_info_gradients); }
