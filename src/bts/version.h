...
namespace BTS {
  ...
  inline bool        before_version (const std::string& version_number_string, size_t major_version, size_t minor_version = 0, size_t micro_version = 0, size_t nano_version = 0) {
    ...
    if (read_major > major_version)
      ...
      size_t read_minor = to<size_t>(version_number_string.substr(major_dot_index + 1, minor_dot_index));
      ...
      if (read_minor > minor_version)
        ...
        size_t read_micro = to<size_t>(version_number_string.substr(minor_dot_index + 1, micro_dot_index));
        ...
        if (read_micro > micro_version)
          ...
          size_t read_nano = to<size_t>(version_number_string.substr(micro_dot_index + 1, nano_dot_index));
