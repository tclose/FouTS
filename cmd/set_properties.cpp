...
template <typename T>  void set_properties(const std::string& input_location, const std::string& output_location, App::Options& opt) {
...
template <typename T>  void set_set_properties(const std::string& input_location, const std::string& output_location, App::Options& opt) {
