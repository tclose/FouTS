...
EXECUTE {
        ...
        if (File::has_extension<Coord>(output_location)) {
            ...
            MR::ProgressBar progress_bar("Randomly generating " + str(number) + " Coord's...",
                    number);
...
#else
            throw Exception(
                    "Macro CODE_TESTING needs to be defined to generate random Fibre::Strand::Sections");
#endif /* CODE_TESTING */
...
#else
            throw Exception(
                    "Macro CODE_TESTING needs to be defined to generate random Fibre::Tractlet::Sections");
#endif /* CODE_TESTING */
            
        } else if (File::has_extension<MCMC::State>(output_location)) {
            
            MR::ProgressBar progress_bar(
                    "Randomly generating " + str(number) + " MCMC::State's of size "
                    + str(state_size) + "...", number);
            ...
            throw Exception(
                    ...
                    + "', can be '" + Coord::FILE_EXTENSION + "', '"
                    + Fibre::Strand::Section::FILE_EXTENSION + "', '"
                    + Fibre::Tractlet::Section::FILE_EXTENSION + "' or '"
                    + MCMC::State::FILE_EXTENSION + "'.");
