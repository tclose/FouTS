...
EXECUTE {
        ...
        Prob::Test::Landscape peaks = Prob::Test::Landscape::randomly_generate(num_dims, num_peaks,
                width_mu, width_sigma, width_min, height_var, roi_radius, fraction_pyramid,
                barrier_rate, seed);
