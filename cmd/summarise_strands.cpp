...
EXECUTE {
  ...
  if (!(save_all || save_v0_norm || save_v1_norm || save_v2_norm || save_dot_v0_v1 || save_dot_v1_v2 || save_angle_v1_v2))
    throw Exception("No options supplied, please select a feature to save");


  std::ofstream v0_norm_out, v1_norm_out, v2_norm_out, dot_v1_v2_out, angle_v1_v2_out, dot_v0_v1_out;
  ...
  MR::ProgressBar progress_bar  ("extractleting features from strand descriptors...", strands.size());
