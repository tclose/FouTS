...
//----------------------------------//
  ...
  Prob::Likelihood::Gaussian likelihood (obs_image, exp_image, like_snr, like_b0_include, like_outside_scale, like_ref_b0, like_ref_signal);
...
//    strands[0].acs = 1.0;
    ...
    MCMC::Proposal::Momentum::Weighted::NonSeparable momentum  = MCMC::Proposal::Momentum::Weighted::NonSeparable::factory( strands,
                                                                                                                            momen_step_scale,
                                                                                                                            momen_step_location,
    ...
    if (burn_num_samples) {
      ...
      burnt_strands = MCMC::riemannian <Fibre::Strand::Set,
    ...
    MCMC::riemannian <Fibre::Strand::Set,
                      Prob::Likelihood::Gaussian,
                      Prob::Prior> (
      burnt_strands,
      likelihood,
  ...
  //------------------------//
    ...
    MCMC::Proposal::Momentum::Weighted::NonSeparable momentum = MCMC::Proposal::Momentum::Weighted::NonSeparable::factory ( tractlets,
                                                                                                                            momen_step_scale,
                                                                                                                            momen_step_location,
                                                                                                                            proposal_distribution,
                                                                                                                            num_newton_steps);
    ...
    if (burn_num_samples) {
      ...
      burnt_tractlets = MCMC::riemannian <Fibre::Tractlet::Set,
                                        Prob::Likelihood::Gaussian,
                                        Prob::Prior> (
    ...
    MCMC::riemannian <Fibre::Tractlet::Set,
                      Prob::Likelihood::Gaussian,
                      Prob::Prior> (
