...
EXECUTE {
        ...
        if (File::has_or_txt_extension<Fibre::Strand>(output_location) || File::has_extension<
                    Fibre::Strand::Set>(output_location)
            || File::has_txt_extension<Fibre::Strand::Set>(output_location)) {
            ...
            if (File::has_or_txt_extension<Fibre::Strand>(output_location)) {
                ...
                || File::has_extension<Fibre::Tractlet::Set>(output_location)
                || File::has_txt_extension<Fibre::Tractlet::Set>(output_location)) {
        ...
        } else if (File::has_or_txt_extension<Fibre::Track>(output_location)
                || File::has_extension<Fibre::Track::Set>(output_location)
                || File::has_txt_extension<Fibre::Track::Set>(output_location)) {
