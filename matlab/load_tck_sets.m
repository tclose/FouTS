function [tck_sets, props, set_prop_keys, set_prop_values, elem_prop_keys, elem_prop_values]  = load_tck_sets(filename, include, load_ext_props)
  ...
  tck_sets = cell(num_include,1);
  
  for set_i = include
    tck_sets{set_i} = parse_tcks(sets{set_i});
  end
