function [section_matrix, labels] = unzip_tract_sections(sections, prop_keys, prop_values)
  ...
  labels{num_props+7} = 'Width 1 - Dim 0';
  labels{num_props+8} = 'Width 1 - Dim 1';
  labels{num_props+9} = 'Width 1 - Dim 2';
  labels{num_props+10} = 'Width 2 - Dim 0';
  labels{num_props+11} = 'Width 2 - Dim 1';
  labels{num_props+12} = 'Width 2 - Dim 2';
end