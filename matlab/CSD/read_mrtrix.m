...
while 1
  ...
  if isempty(d)
    ...
    elseif strcmp(key, 'conv_type')
      image.conv_type = value;
    elseif strcmp(key, 'num_points')
      image.num_points = value;
    elseif strcmp(key, 'num_segments')
      image.num_segments = value;
    elseif strcmp(key, 'strands_file')
      image.strands_file = value;  
    elseif strcmp(key, 'interpolation')
      image.interpolation = value;      
    elseif strcmp(key, 'interpolation_extent')
      image.interpolation_extent = value;
    elseif strcmp(key, 'purpose')
      image.purpose = value;
    elseif strcmp(key, 'response_coeffs')
      image.response_coeffs = value;      
    elseif strcmp(key, 'datetime')
      image.datetime = value;
